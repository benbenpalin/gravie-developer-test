...
The `home-routes` handler in the `gravie-developer-test.routes.home` namespace
...
The `home-page` function will in turn call the `gravie-developer-test.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/gravie_developer_test/core.cljs` file.



<p class="title is-5">Organizing the routes</p>

The routes are aggregated and wrapped with middleware in the `gravie-developer-test.handler` namespace:
...
Request middleware functions are located under the `gravie-developer-test.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `gravie-developer-test.dev-middleware` namespace found in
